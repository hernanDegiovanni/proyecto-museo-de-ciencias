               ...
               <div class="row">
                  <div class="col-md-8 offset-md-2">
                     <ul class="location_icon">
                        <li><a href="#"><i class="fa fa-map-marker" aria-hidden="true"></i></a><br> locacion</li>
                        <li><a href="#"><i class="fa fa-phone" aria-hidden="true"></i></a><br> +54 3408-111111</li>
                        <li><a href="#"><i class="fa fa-envelope" aria-hidden="true"></i></a><br> museo@gmail.com</li>
                     </ul>
                  </div>
               </div>
            </div>
